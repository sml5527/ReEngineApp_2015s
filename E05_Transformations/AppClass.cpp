...
void AppClass::InitVariables(void)
{
	...
	m_m4Cone =	 IDENTITY_M4;
	m_m4Cube = IDENTITY_M4;
	m_m4Cylinder = IDENTITY_M4;
	m_m4Tube = IDENTITY_M4;
	m_m4Torus = IDENTITY_M4;
...
void AppClass::Update(void)
{
	...
	m_m4Cone = glm::translate(IDENTITY_M4, vector3(0, 1.5f, 0));
	...
	//m_m4Torus = glm::scale(m_m4Torus, vector3(1.5f, 1.5f, 1.5f));
